...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        .setTitle('Ewing35 Çekiliş Botu Yardım Menüsü')
        ...
        .setFooter(`Developed by Ewing35 💖`)
        .setThumbnail(client.user.avatarURL());
        const buton = new MessageButton().setLabel('Ewing35 Youtube').setStyle('LINK').setURL('http://gweepcreative.com');
